...
func (c *Client) QueryTxByID(txid string, endpoint string) ([]byte, error) {
	...
	return transactions.TransactionEnvelope.GetPayload(), nil
}
...
//	var writes []string
//	bf := bytes.Buffer{}
//	rws := transh.getReadWriteSet((*common.Envelope)(transactions.GetTransactionEnvelope()))
//	for _, u := range rws {
